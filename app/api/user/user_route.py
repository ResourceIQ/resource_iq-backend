...
@router.post(
    "/", dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))], response_model=UserPublic
)
...
@router.patch("/me", response_model=UserPublic,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
def update_user_me(
...
@router.patch("/me/password", response_model=Message,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
...
@router.get("/me", response_model=UserPublic,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
...
@router.delete("/me", response_model=Message,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
...
@router.post("/signup", response_model=UserPublic,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
...
@router.get("/{user_id}", response_model=UserPublic,dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
def read_user_by_id(
...
@router.delete("/{user_id}", dependencies=[Depends(RoleChecker([Role.ADMIN,Role.MODERATOR]))])
def delete_user(
